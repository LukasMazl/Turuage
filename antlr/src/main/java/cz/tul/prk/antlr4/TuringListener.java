...
public interface TuringListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TuringParser#tape_statement}.
	 * @param ctx the parse tree
	 */
	void enterTape_statement(TuringParser.Tape_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link TuringParser#tape_statement}.
	 * @param ctx the parse tree
	 */
	void exitTape_statement(TuringParser.Tape_statementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TuringParser#tape_move}.
	 * @param ctx the parse tree
	 */
	void enterTape_move(TuringParser.Tape_moveContext ctx);
	/**
	 * Exit a parse tree produced by {@link TuringParser#tape_move}.
	 * @param ctx the parse tree
	 */
